...
const FAQ = () => {
  ...
  return (
    <>
      <SEO
        title="FAQ - Pharmaceutical Export & Trading Information"
        description="Find answers to common questions about Baker & Davis's pharmaceutical services, quality certifications, production capacity, and global export capabilities."
      />
