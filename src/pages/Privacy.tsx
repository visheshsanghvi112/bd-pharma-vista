...
const Privacy = () => {
  return (
    <>
      <SEO
        title="Privacy Policy - Baker & Davis Pharmaceuticals"
        description="Learn about Baker & Davis's commitment to protecting your privacy. Read our comprehensive privacy policy regarding data collection, usage, and protection measures."
      />
