...
const Home = () => {
  ...
  return (
    <>
      <SEO
        title="Leading Global Pharmaceutical Export & Trading Company"
        description="Baker & Davis - A trusted pharmaceutical manufacturer and global exporter committed to improving lives through quality healthcare products. Explore our range of pharmaceutical solutions and global distribution network."
      />
