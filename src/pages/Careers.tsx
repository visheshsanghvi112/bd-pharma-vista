...
const Careers = () => {
  ...
  return (
    <>
      <SEO
        title="Careers at Baker & Davis - Global Pharmaceutical Opportunities"
        description="Join Baker & Davis's team of pharmaceutical professionals. Explore career opportunities in pharmaceutical manufacturing, export, and global trade."
      />
