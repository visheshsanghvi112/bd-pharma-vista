...
const About = () => {
  ...
  return (
    <>
      <Seo 
        title="About"
        description="Learn about Baker & Davis, a leading global pharmaceutical manufacturer and exporter with WHO-GMP certification and FDA approval. Discover our commitment to quality healthcare solutions."
      />
