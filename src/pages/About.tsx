...
const About = () => {
  ...
  return (
    <>
      <SEO
        title="About Our Global Pharmaceutical Company"
        description="Baker & Davis is a leading global pharmaceutical company specializing in export and trading. With over two decades of experience, we deliver trusted pharmaceutical solutions worldwide through innovation, quality, and accessibility."
      />
