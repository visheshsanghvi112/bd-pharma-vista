...
const Contact = () => {
  ...
  return (
    <>
      <SEO
        title="Contact Baker & Davis - Global Pharmaceutical Solutions"
        description="Get in touch with Baker & Davis for pharmaceutical export inquiries, partnership opportunities, and global distribution. Located in Mumbai, India, we serve healthcare providers worldwide."
      />
